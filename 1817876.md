...
![erro no teste estrutural](https://github.com/Beluomini/masters-degree-computer-science/blob/main/image.png?raw=true)

Primeira rodada de teste de mutação 78% após correção do código e sucesso nos testes.

![Primeiro teste de mutação](https://github.com/Beluomini/masters-degree-computer-science/blob/main/image-1.png?raw=true)

Erro capturado ao tentar melhorar o teste de mutação, código não suporta limite 0 ou negativo

![limite não positivo](https://github.com/Beluomini/masters-degree-computer-science/blob/main/image-2.png?raw=true)

Melhoria de 13% ao corrigir teste e código novamente.

![melhoria](https://github.com/Beluomini/masters-degree-computer-science/blob/main/image-3.png?raw=true)
